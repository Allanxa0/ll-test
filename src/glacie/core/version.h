...
#define PLUGIN_NAME "Glacie"

#define PLUGIN_INTRODUCTION "Glacie - Via Version Plugin for BDS"
#define PLUGIN_AUTHOR       "GlacieTeam"
...
#define PLUGIN_FILE_VERSION_STRING                                                                                     \
    TO_VERSION_STRING(PLUGIN_VERSION_MAJOR.PLUGIN_VERSION_MINOR.PLUGIN_VERSION_REVISION.PLUGIN_VERSION_ACTIONS BETA)
...
#define PLUGIN_FILE_VERSION_STRING                                                                                     \
    TO_VERSION_STRING(PLUGIN_VERSION_MAJOR.PLUGIN_VERSION_MINOR.PLUGIN_VERSION_REVISION.PLUGIN_VERSION_ACTIONS DEV)
#else

#define PLUGIN_FILE_VERSION_FLAG 0x0L
#define PLUGIN_LLVERSION_STATUS  ll::Version::Release
#define PLUGIN_FILE_VERSION_STRING                                                                                     \
    TO_VERSION_STRING(PLUGIN_VERSION_MAJOR.PLUGIN_VERSION_MINOR.PLUGIN_VERSION_REVISION.PLUGIN_VERSION_ACTIONS)
